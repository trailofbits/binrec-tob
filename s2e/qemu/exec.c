        ...
        if (!(tb_end <= start || tb_start >= end)) {
            ...
            if (current_tb_not_found) {
                ...
                if (env->mem_io_pc) {
                    ...
                    //TODO: mem_io_pc is never set in S2E, use s2e_current_tb instead!
...
static BounceBuffer* bounce_buffer_alloc(void)
{
    ...
    memset(s_bounce_buffers + old_count, 0, (s_max_bounce_buffers - old_count) * sizeof(BounceBuffer));
