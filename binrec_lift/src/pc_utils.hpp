#ifndef BINREC_PC_UTILS_HPP
#define BINREC_PC_UTILS_HPP
...
namespace binrec {
    ...
    auto getLastInstStartPc(llvm::BasicBlock *bb, bool allowEmpty = false, bool noRecovered = false)
        -> unsigned;

    static inline auto isInstStart(llvm::Instruction *inst) -> bool
    {
        return inst->getMetadata("inststart");
    }

    static inline auto getLastPc(llvm::Function *f) -> unsigned
    {
    ...
    template <typename T> static inline auto haveSameEndAddress(T *a, T *b) -> bool
    {
