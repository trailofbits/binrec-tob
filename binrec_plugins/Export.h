...
protected:
    ...
    void initializeModule(const ModuleDescriptor &module, const ConfigFile::string_list &baseDirs);
...
private:
    ...
    auto areBBsEqual(llvm::Function *a, llvm::Function *b, bool *aIsValid, bool *bIsValid) -> bool;
