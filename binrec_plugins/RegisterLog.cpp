    ...
    namespace plugins {
        ...
        void RegisterLog::initialize()
        {
            std::string logFileName =
                s2e()->getConfig()->getString(getConfigKey() + ".logFile", "register-log.txt");
            ...
            m_connExec =
                selector->onModuleExecute.connect(sigc::mem_fun(*this, &RegisterLog::writeLogLine));
...
#define PRT_VAL(prefix, value) m_logFile << prefix "=" << std::setw(8) << hexval(value);
...
#undef PRT_VAL
        ...
        void RegisterLog::slotStateFork(
