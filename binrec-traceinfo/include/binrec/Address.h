#ifndef BINREC_ADDRESS_H
#define BINREC_ADDRESS_H
...
template <typename Tag> struct TypedAddress {
    ...
    auto operator==(TypedAddress other) const -> bool { return value == other.value; }
    auto operator!=(TypedAddress other) const -> bool { return value != other.value; }
    auto operator<(TypedAddress other) const -> bool { return value < other.value; }
    auto operator<=(TypedAddress other) const -> bool { return value <= other.value; }
    auto operator>=(TypedAddress other) const -> bool { return value >= other.value; }
...
template <typename Tag> auto operator<<(std::ostream &os, TypedAddress<Tag> address) -> std::ostream & {
    std::stringstream ss;
...
public:
    ...
    auto contains(Address address) const -> bool { return begin <= address && address < end; }
    auto overlaps(AddressRange other) const -> bool { return end <= other.begin || other.end <= begin; }

    auto operator<(AddressRange other) const -> bool { return end <= other.begin; }
    auto operator>(AddressRange other) const -> bool { return begin >= other.end; }

    auto operator<(Address address) const -> bool { return end <= address; }
    auto operator>(Address address) const -> bool { return begin > address; }
};
