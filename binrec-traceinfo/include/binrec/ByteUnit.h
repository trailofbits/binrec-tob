#ifndef BINREC_BYTEUNIT_H
#define BINREC_BYTEUNIT_H
...
template <typename Tag> struct ByteUnit {
    ...
    auto operator==(ByteUnit other) const -> bool { return value == other.value; }
    auto operator!=(ByteUnit other) const -> bool { return value != other.value; }
    auto operator<(ByteUnit other) const -> bool { return value < other.value; }
    auto operator<=(ByteUnit other) const -> bool { return value <= other.value; }
    auto operator>=(ByteUnit other) const -> bool { return value >= other.value; }
    ...
    auto operator+(ByteUnit other) const -> ByteUnit { return ByteUnit(value + other.value); }
};
