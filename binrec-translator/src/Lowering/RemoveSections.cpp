...
auto getInt32(Module &m, unsigned i) -> ConstantInt * { return ConstantInt::get(Type::getInt32Ty(m.getContext()), i); }
...
// NOLINTNEXTLINE
auto RemoveSectionsPass::run(Module &m, ModuleAnalysisManager &) -> PreservedAnalyses {
